...
17: \\(\qquad \mathbf{A}\_0 \leftarrow \mathbf{A}\_0 + \mathbf{B}^{\mathsf{T}}_a_t\mathbf{A}^{-1}_a_t\mathbf{B}_a_t \\)
18: \\(\qquad \mathbf{b}\_0 \leftarrow \mathbf{b}\_0 + \mathbf{B}^{\mathsf{T}}_a_t\mathbf{A}^{-1}_a_t\mathbf{b}_a_t \\)
