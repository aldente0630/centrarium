...
개인화 된 뉴스 기사 추천의 문제는 자연스럽게 컨텍스트 정보가있는 다중 무장 한 산적 문제로 모델링 될 수 있습니다. 이전 연구 [18]에 따라, 우리는 이것을 문맥 적 산적이라고 부른다.
1.공식적으로 문맥 적 알고리즘 A는 이산 적 재판 t = 1, 2, 3, ...으로 진행된다. 재판에서 :
