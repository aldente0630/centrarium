...
### 변수 사용에 대하여
  ...
  먼저 기사 추천에 변수를 사용하는 것이 도움이 되는지 조사해보자. 사용자 변수를 고려한 **\\(\epsilon\\)-탐욕(세분화/분리/혼합)**과 UCB 방법(**ucb (새분화)**와 **linucb(분리/혼합)**) 모두 기준선인 **\\(\epsilon\\)-탐욕** 대비 CTR 상승분 약 10% 넘게 달성했음을 표1에서 확인할 수 있다. 
