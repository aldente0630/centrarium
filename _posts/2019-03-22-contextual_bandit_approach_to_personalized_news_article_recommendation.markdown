...
이 섹션에서는 섹션 4의 오프라인 평가 방법을 사용하여 실제 응용 프로그램에서 제안 된 LinUCB 알고리즘의 용량을 확인합니다. 먼저 Yahoo!에서 문제 설정을 소개합니다. Today-Module을 사용한 다음 실험에 사용한 사용자 / 항목 속성을 설명합니다. 마지막으로 성능 메트릭을 정의하고 몇 가지 표준 (문맥) 산적 알고리즘과 비교하여 실험 결과를보고합니다.
