...
엄격하고 통제된 실험을 수행하기 위해 2013년 4 분기 중 한 주를 임의로 선택하여 오프라인 훈련 데이터를 준비했다. 다른 조건에서 동일한 교육 및 테스트 데이터를 유지하기 위해 오프라인 훈련 데이터를 준비했습니다. 온라인으로 관찰. 저장된 오프라인 데이터를 교육 및 테스트로 분할하여 온라인 교육 및 예측을위한 스트리밍 데이터를 시뮬레이션합니다. 동일한 교육 / 테스트 데이터가이 문서의 모든 실험에 대한 테스트 베드로 사용됩니다.
