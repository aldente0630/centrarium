...
부스팅 모형에서 사용한 변수는 두 가지 유형, 즉 맥락 변수와 이력 변수로 구분할 수 있다. 문맥 적 기능의 가치는 사용자가 사용하는 기기 또는 사용자가 현재 사용중인 페이지와 같이 광고가 게재 될 문맥에 관한 최신 정보에만 의존합니다. 반대로 과거의 기능은 광고 또는 사용자의 이전 상호 작용 (예 : 지난 주 광고의 클릭률 또는 사용자의 평균 클릭률)에 따라 달라집니다.
