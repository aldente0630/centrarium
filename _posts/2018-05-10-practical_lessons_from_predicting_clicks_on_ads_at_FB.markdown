...
$$\mu_i\_{j} \leftarrow \mu_i\_{j} + y \cdot {\sigma^2_i\_{j} \over \Sigma} \cdot v \left({s(y, \mathbf{x}, \mathbf{\mu}) \over \Sigma}\right), $$
  
$$\sigma^2_i\_{j} \leftarrow \sigma^2_i\_{j} \cdot \left\[1 - {\sigma^2_i\_{j} \over \Sigma^2} \cdot w {s(y, \mathbf{x}, \mathbf{\mu}) \over \Sigma}\right\], $$
