...
>사용한 도구: Airbnb 내부 변수 저장소 — Zipline
 ...
  지도 기계 학습 프로젝트 첫 번째 단계 중 하나는 선택한 결과 변수와 상관성이 있을 관련 변수들을 정의하는 것이다. 이 과정을 피쳐 엔지니어링이라고한다. 예를 들어 LTV 예측할 때 목록을 이용할 수 있는 차기 180 달력일의 백분율 또는 동일한 시장에서 비교할 수 있는 목록과 관련된 목록 가격을 계산할 수 있다.
