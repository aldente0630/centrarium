...
이전에 언급했듯이 제품화 파이프라인을 구축하는 것은 로컬 랩탑에서 프로토타입을 제작하는 것과 상당히 다릅니다. 예를 들어 정기적 인 재교육을 어떻게 수행 할 수 있습니까? 얼마나 많은 수의 예제를 효율적으로 채점합니까? 우리는 시간이 지남에 따라 모델 성능을 모니터링하는 파이프 라인을 어떻게 구축합니까?
