...
# 끝맺으며
  ...
  Top 10 스타일처럼 조언 목록을 짧게 쓸 수 없었다.(세보지 않았는가? 여기에 24개의 항목이 있다). 이러한 아이디어를 실제 문제에 적용하면 도메인에서 가장 중요한 습관과 기술, 이러한 분석을 빠르고 정확하게 수행하는 데 도움이 되는 도구 및 원하는 조언이 이 목록에 있다. 배운 내용을 공유하며 더 훌륭한 데이터 과학자가 되길 바란다.
