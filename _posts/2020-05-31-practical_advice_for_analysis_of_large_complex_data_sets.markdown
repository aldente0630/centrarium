...
### 고객을 교육하라
  ...
  데이터 전문가가 아닌 사람들에게 분석과 업무 결과를 설명해줘야하는 경우가 자주 있다. 그들이 데이터를 해석하고 결론을 바르게 도출하게끔 교육시키는 것이 우리 업무의 일부이다. 이로 인해 영역에서 특정 측정값이 신뢰할 수 없는 이유, 인구 편향 효과를 이해하기위한 “좋은”및 “나쁜”변경에 대한 일반적인 효과 크기에 대한 신뢰 구간을 이해하는 것부터 색 영역이 실행됩니다.

이러한 과정은 데이터가 잘못 해석되거나 선택적으로 인용될 가능성이 높은 경우 특히나 중요하다. 고객이 요청한 숫자 뿐만 아니라 데이터의 맥락과 전체 그림을 알려줄 의무가 있다.
