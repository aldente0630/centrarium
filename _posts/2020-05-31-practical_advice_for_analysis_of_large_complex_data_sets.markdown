...
### 실험/데이터 수집 설정을 확인하라
  ...
  데이터를 살펴보기 전에 실험과 데이터 수집 설정을 이해해야한다. 실험을 수행하는 사람과 분석하는 사람 간에 정확한 의사소통은 난제 중 하나이다. 실험 프로토콜 또는 구성을 직접 살펴볼 수 있다면 그렇게 해야한다. 만약 그렇게 할 수 없다면 설정에 대해 본인이 이해한 바를 적어보고 데이터 생성을 담당하는 사람에게 그게 맞는지 확인해야한다.
