...
### 회의론자와 챔피언
  ...
  당신은 데이터를 다루면서 얻은 인사이트를 자신있게 이야기하는 챔피언인 동시에 회의론자가 되어야 한다. 당신이 바라던대로 데이터에서 흥미로운 현상을 발견할 수 있다. 흥미로운 현상을 발견하면 “이걸 멋지게 보여주려면 어떤 다른 데이터를 수집해야 할까?”와 “무엇이 이것을 의미없게 만들 수 있을까?”를 동시에 물어야한다. 특히 특정 대답을 원하는 사람(예: “내가 만든 기능은 훌륭하다”)을 위해 분석을 수행하는 경우 오류를 피하기 위해서는 회의론자가 되어야 한다.
